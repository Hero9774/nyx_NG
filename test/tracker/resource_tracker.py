...
from nyx_ng.tracker import ResourceTracker, _resources_via_ps, _resources_via_proc
...
class TestResourceTracker(unittest.TestCase):
  ...
  @patch('nyx_ng.tracker._resources_via_proc')
  @patch('nyx_ng.tracker.system', Mock(return_value = Mock()))
  @patch('nyx_ng.tracker.proc.is_available', Mock(return_value = True))
  ...
  @patch('nyx_ng.tracker.tor_controller')
  @patch('nyx_ng.tracker.proc.is_available')
  @patch('nyx_ng.tracker._resources_via_ps', Mock(return_value = (105.3, 2.4, 8072, 0.3)))
  @patch('nyx_ng.tracker._resources_via_proc', Mock(return_value = (340.3, 3.2, 6020, 0.26)))
  @patch('nyx_ng.tracker.system', Mock(return_value = Mock()))
  ...
  @patch('nyx_ng.tracker.tor_controller')
  @patch('nyx_ng.tracker._resources_via_ps', Mock(return_value = (105.3, 2.4, 8072, 0.3)))
  @patch('nyx_ng.tracker._resources_via_proc', Mock(side_effect = IOError()))
  @patch('nyx_ng.tracker.system', Mock(return_value = Mock()))
  @patch('nyx_ng.tracker.proc.is_available', Mock(return_value = True))
  ...
  @patch('nyx_ng.tracker.system.call', Mock(return_value = PS_OUTPUT.split('\n')))
  ...
  @patch('nyx_ng.tracker.proc.stats', Mock(return_value = (1.5, 0.5, 1388967200.9)))
  @patch('nyx_ng.tracker.proc.memory_usage', Mock(return_value = (19300352, 6432)))
  @patch('nyx_ng.tracker.proc.physical_memory', Mock(return_value = 4825088000))
