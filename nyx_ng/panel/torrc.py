...
from nyx_ng import expand_path, panel, tor_controller
...
class TorrcPanel(panel.Panel):
  ...
  def key_handlers(self):
    ...
    return (
      ...
      nyx_ng.panel.KeyHandler('s', 'comment stripping', _toggle_comment_stripping, 'off' if self._show_comments else 'on'),
      nyx_ng.panel.KeyHandler('l', 'line numbering', _toggle_line_numbers, 'on' if self._show_line_numbers else 'off'),
    )
